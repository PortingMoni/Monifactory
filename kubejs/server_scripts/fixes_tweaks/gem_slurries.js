...
ServerEvents.recipes(event => {
    ...
    gems.forEach(gem => {
        ...
        if(gem.products != null) {
            ...
            gem.products.forEach(product => {
                centrifuge_recipe.chancedOutput(`gtceu:${product.name}_dust`, product.chance)
            })
        }
    })
    ...
    event.recipes.gtceu.centrifuge("malachite_slurry_centrifuging")
        ...
        .chancedOutput("gtceu:calcite_dust", 6000)
        .chancedOutput("gtceu:iron_dust", 1500)
        .chancedOutput("gtceu:phosphate_dust", 1000)
        .outputFluids("gtceu:diluted_hydrochloric_acid 1900")
        .duration(8 * 20)
        .EUt(GTValues.VHA[GTValues.MV])
    ...
    event.recipes.gtceu.centrifuge("olivine_slurry_centrifuging")
        ...
        .chancedOutput("gtceu:calcium_dust", 1500)
        .chancedOutput("gtceu:aluminium_dust", 1000)
        .chancedOutput("gtceu:nickel_dust", 1500)
        .chancedOutput("gtceu:manganese_dust", 1000)
        .outputFluids("gtceu:diluted_hydrochloric_acid 1900")
        .duration(8 * 20)
        .EUt(GTValues.VHA[GTValues.MV])
})
