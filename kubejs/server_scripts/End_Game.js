...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.electrolyzer("actinium_from_uranic_solution")
        ...
        .chancedInput("kubejs:neutron_emitter", 50)
        .chancedOutput("gtceu:actinium_dust", 2000)
        .chancedOutput("gtceu:thorium_dust", 3333)
        .chancedOutput("3x gtceu:uraninite_dust", 5000)
    ...
    event.recipes.gtceu.electrolyzer("actinium_from_radium_salt")
        ...
        .chancedFluidOutput("gtceu:actinium 72", 2000)
        .chancedFluidOutput("gtceu:radon 125", 8000)
    ...
    event.recipes.gtceu.large_chemical_reactor("stem_cells")
        ...
        .chancedInput("minecraft:sculk_catalyst", 500)
