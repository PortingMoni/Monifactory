...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.centrifuge("moon_dust_centrifuging")
        ...
        .chancedOutput("gtceu:glass_dust", 2500)
        .chancedOutput("gtceu:quicklime_dust", 2300)
        .chancedOutput("gtceu:ilmenite_dust", 2000)
        .chancedOutput("gtceu:anorthite_dust", 1400)
        .chancedOutput("gtceu:magnesia_dust", 1200)
        .chancedOutput("gtceu:extraterrestrial_metal_mixture_dust", 1000)
    ...
    event.recipes.gtceu.centrifuge("mars_dust_centrifuging")
        ...
        .chancedOutput("minecraft:sand", 4000)
        .chancedOutput("gtceu:hematite_dust", 2300)
        .chancedOutput("gtceu:calcium_perchlorate_dust", 2000)
        .chancedOutput("gtceu:basaltic_mineral_sand_dust", 900)
        .chancedOutput("gtceu:zincite_dust", 700)
        .chancedOutput("gtceu:extraterrestrial_metal_mixture_dust", 1000)
        .duration(200)
        .EUt(GTValues.VA[GTValues.HV])
    ...
    event.recipes.gtceu.centrifuge("venus_dust_centrifuging")
        ...
        .chancedOutput("gtceu:quartz_sand_dust", 3000)
        .chancedOutput("gtceu:chalcopyrite_dust", 2600)
        .chancedOutput("gtceu:calcium_carbonate_dust", 1800)
        .chancedOutput("gtceu:apatite_dust", 1600)
        .chancedOutput("gtceu:carbon_dust", 1300)
        .chancedOutput("gtceu:extraterrestrial_metal_mixture_dust", 1200)
    ...
    event.recipes.gtceu.centrifuge("mercury_dust_centrifuging")
        ...
        .chancedOutput("gtceu:stone_dust", 2900)
        .chancedOutput("gtceu:basaltic_mineral_sand_dust", 2700)
        .chancedOutput("gtceu:garnet_sand_dust", 2000)
        .chancedOutput("gtceu:fullers_earth_dust", 1650)
        .chancedOutput("minecraft:redstone", 1400)
        .chancedOutput("gtceu:extraterrestrial_metal_mixture_dust", 1200)
        .duration(200)
        .EUt(GTValues.VA[GTValues.EV])
    ...
    event.recipes.gtceu.centrifuge("glacio_dust_centrifuging")
        ...
        .chancedOutput("gtceu:granitic_mineral_sand_dust", 4500)
        .chancedOutput("gtceu:kyanite_dust", 3750)
        .chancedOutput("gtceu:alunite_dust", 2500)
        .chancedOutput("gtceu:oilsands_dust", 2250)
        .chancedOutput("gtceu:bastnasite_dust", 1700)
        .chancedOutput("gtceu:extraterrestrial_metal_mixture_dust", 1500)
        .duration(200)
    ...
    event.recipes.gtceu.centrifuge("extraterrestrial_metal_mixture_centrifuging")
        ...
        .chancedOutput("gtceu:ilmenite_dust", 6000)
        .chancedOutput("gtceu:chromite_dust", 4000)
        .chancedOutput("gtceu:pyrolusite_dust", 3500)
        .chancedOutput("gtceu:wulfenite_dust", 2500)
        .chancedOutput("gtceu:tungstate_dust", 2200)
        .duration(1000)
        .EUt(GTValues.VA[GTValues.IV])
    ...
    event.recipes.gtceu.macerator("macerate_conglomerate")
        ...
        .chancedOutput("gtceu:mirabilite_dust", 2500)
        .chancedOutput("gtceu:redrock_dust", 2500)
        .chancedOutput("gtceu:biotite_dust", 2500)
        .chancedOutput("gtceu:gypsum_dust", 2500)
        .duration(200)
        .EUt(GTValues.VHA[GTValues.MV])

    event.recipes.gtceu.macerator("macerate_infernal_spire")
        .itemInputs("ad_astra:infernal_spire_block")
        .chancedOutput("minecraft:blaze_powder", 5000)
        .chancedOutput("gtceu:bauxite_dust", 2800)
        .chancedOutput("gtceu:scheelite_dust", 2000)
        .chancedOutput("gtceu:sulfur_dust", 800)
        .duration(200)
    ...
    event.recipes.gtceu.chemical_bath("tungstic_acid_from_wolframite")
        ...
        .chancedOutput("3x gtceu:iron_ii_chloride_dust", 5000)
        .chancedOutput("3x gtceu:manganese_ii_chloride_dust", 5000)
