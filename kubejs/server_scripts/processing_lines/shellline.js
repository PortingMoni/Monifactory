...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.sifter("sift_crushed_shulker_shell")
        ...
        .chancedOutput("minecraft:popped_chorus_fruit", 7000)
    ...
    event.recipes.gtceu.electromagnetic_separator("separate_niobium_palladium_grit")
        ...
        .chancedOutput(doHarderProcessing ? "gtceu:niobium_pentoxide_dust" : "gtceu:niobium_dust", doHarderProcessing ? 3500 : 1000)
        .chancedOutput("gtceu:niobium_nugget", 2000)
        .duration(10 * 20)
