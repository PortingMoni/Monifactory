...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.distillation_tower("naquadah_isotope_distillation")
        ...
        .chancedOutput("kubejs:naquadah_waste", 1000)
    ...
    event.recipes.gtceu.distillation_tower("light_isotope_distillation")
        ...
        .chancedOutput("gtceu:lead_dust", 2500)
    ...
    event.recipes.gtceu.distillation_tower("medium_isotope_distillation")
        ...
        .chancedOutput("gtceu:cerium_dust", 1000)
    ...
    event.recipes.gtceu.distillation_tower("heavy_isotope_distillation")
        ...
        .chancedOutput("gtceu:trinium_dust", 3333)
    ...
    event.recipes.gtceu.distillation_tower("sludge_distillation")
        ...
        .chancedOutput("kubejs:naquadah_waste", 5000)
    ...
    event.recipes.gtceu.distillation_tower("heavy_residue_distillation")
        ...
        .chancedOutput("kubejs:naquadah_waste", 6600)
    ...
    event.recipes.gtceu.distillation_tower("superheavy_residue_distillation")
        ...
        .chancedOutput("kubejs:naquadah_waste", 9000)
    ...
    event.recipes.gtceu.centrifuge("crude_waste_processing")
        ...
        .chancedOutput("3x gtceu:thorium_dust", 5000)
        .chancedOutput("3x kubejs:naquadah_waste", 6600)
        .chancedFluidOutput("gtceu:americium 100", 3300)
        .duration(1200)
        .EUt(122800)
    ...
    event.recipes.gtceu.centrifuge("liquid_waste_processing")
        ...
        .chancedOutput("4x gtceu:enriched_naquadah_dust", 5000)
        .chancedOutput("3x kubejs:naquadah_waste", 6600)
        .chancedFluidOutput("gtceu:exotic_particle_solution 100", 3300)
        .duration(1200)
        .EUt(GTValues.VA[GTValues.UV])
    ...
    event.recipes.gtceu.centrifuge("superfuel_waste_processing")
        ...
        .chancedOutput("1x gtceu:infinity_dust", 3300)
        .chancedOutput("3x kubejs:naquadah_waste", 6600)
        .chancedOutput("16x gtceu:naquadria_dust", 5000)
        .chancedFluidOutput("monilabs:eltz 228", 5000)
        .chancedFluidOutput("gtceu:hyperdegenerate_matter 100", 3300)
        .duration(1200)
        .EUt(GTValues.VA[GTValues.UHV])
    */
    ...
    event.recipes.gtceu.centrifuge("naquadah_waste_centrifuging")
        ...
        .chancedOutput("gtceu:trinium_dust", 3333)
        .chancedOutput("gtceu:curium_dust", 1000)
        .chancedOutput("gtceu:duranium_dust", 1000)
        .duration(100)
        .EUt(GTValues.VA[GTValues.EV])
})
