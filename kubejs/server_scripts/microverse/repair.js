...
ServerEvents.recipes(event => {
    ...
    repairing(6)
        ...
        .chancedInput("2x gtceu:double_enderium_plate", 7000)
        .chancedInput("kubejs:supercharged_laser_array", 3000)
        .chancedItemInputLogic(ChanceLogic.XOR)

    repairing(7)
        .EUt(GTValues.VA[GTValues.LuV])
        .chancedInput("2x gtceu:double_cryolobus_plate", 4000)
        .chancedInput("2x gtceu:double_naquadah_plate", 3000)
        .chancedInput("kubejs:supercharged_laser_array", 3000)
        .chancedItemInputLogic(ChanceLogic.XOR)

    repairing(8)
        .EUt(GTValues.VA[GTValues.ZPM])
        .chancedInput("2x monilabs:double_crystal_matrix_plate", 3000)
        .chancedInput("2x gtceu:double_rhodium_plated_palladium_plate", 2500)
        .chancedInput("2x gtceu:double_duranium_plate", 2000)
        .chancedInput("2x kubejs:supercharged_laser_array", 2500)
        .chancedItemInputLogic(ChanceLogic.XOR)

    // Combat miners always need repairs for engaging in combat
    repairing("2half")
        .EUt(GTValues.VHA[GTValues.EV])
        .chancedInput("2x gtceu:double_dark_steel_plate", 7000)
    ...
    repairing("4half")
        ...
        .chancedInput("2x gtceu:double_hsse_plate", 3500)
        .chancedInput("redstone_arsenal:flux_sword", 3000)
        .chancedItemInputLogic(ChanceLogic.XOR)
})
