...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.centrifuge("coal_fly_ash_centrifuge")
        ...
        .chancedOutput("gtceu:fly_ash_polymineral_mixture_dust", 8000)
        .chancedOutput("gtceu:fly_ash_polymineral_mixture_dust", 7700)
        .chancedOutput("gtceu:fly_ash_iron_mineral_mixture_dust", 7500)
        .chancedOutput("gtceu:fly_ash_iron_mineral_mixture_dust", 6666)
        .chancedOutput("gtceu:fly_ash_aluminosilicate_dust", 5500)
        .duration(400)
    ...
    event.recipes.gtceu.chemical_bath("kubejs:polymineral_leachate")
        ...
        .chancedOutput("gtceu:mica_dust", 2500)
        .chancedOutput("ae2:certus_quartz_dust", 2500)
        .chancedOutput("gtceu:quartzite_dust", 2500)
        .chancedOutput("gtceu:marble_dust", 2500)
    ...
    event.recipes.gtceu.centrifuge("polymineral_leachate_centrifuge")
        ...
        .chancedOutput("gtceu:nickel_dust", 7500)
        .chancedOutput("gtceu:small_germanium_dust", 6666)
    ...
    event.recipes.gtceu.electrolyzer("kubejs:iron_mineral_solution_electrolysis")
        ...
        .chancedOutput("gtceu:germanium_dust", 3500)
        .itemOutputs("2x gtceu:goethite_dust")
        .chancedOutput("gtceu:yellow_limonite_dust", 5000)
        .chancedOutput("gtceu:sphalerite_dust", 5000)
        .chancedOutput("gtceu:small_gallium_dust", 2000)
