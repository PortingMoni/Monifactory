...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.sifter("scrap_sifting")
        ...
        .chancedOutput("kubejs:ruined_machine_parts", 4500)
        .itemOutputs("kubejs:ruined_hull")
        .chancedOutput("kubejs:ruined_hull", 6600)
        .chancedOutput("kubejs:ruined_hull", 5000)
        .chancedOutput("gtceu:ruthenium_trinium_americium_neutronate_dust", 3300)
        .duration(400)
        .EUt(16380)
    ...
    event.recipes.gtceu.sifter("ruined_machine_sifting")
        ...
        .chancedOutput("gtceu:graphene_dust", 3000)
        .chancedOutput("gtceu:yttrium_barium_cuprate_dust", 3000)
        .chancedOutput("kubejs:ruined_capacitor", 5000)
        .chancedOutput("kubejs:ruined_sensor", 5000)
        .chancedOutput("kubejs:ruined_emitter", 5000)
        .duration(400)
        .EUt(16380)
    ...
    event.recipes.gtceu.centrifuge("ruined_hull_maceration")
        ...
        .chancedOutput("kubejs:crushed_sensor", 3300)
        .chancedOutput("kubejs:magnetic_capacitor_dust", 3300)
        .chancedOutput("kubejs:necrosiderite_oxide_glass_dust", 3300)
        .duration(400)
        .EUt(16380)
    ...
    event.recipes.gtceu.macerator("alien_scrap_supercap_crushing")
        ...
        .chancedOutput("kubejs:crushed_capacitor", 9500)
        .chancedOutput("gtceu:enriched_naquadah_trinium_europium_duranide_dust", 1500)
        .duration(100)
        .EUt(16380)

    event.recipes.gtceu.electromagnetic_separator("alien_scrap_supercap_electro")
        .itemInputs("kubejs:crushed_capacitor")
        .chancedOutput("kubejs:magnetic_capacitor_dust", 9500)
        .chancedOutput("gtceu:carbon_dust", 6000) // Finally, an easy way to get carbon!
        .duration(100)
        .EUt(16380)
    ...
    event.recipes.gtceu.centrifuge("alien_scrap_supercap_dust_centrifuge")
        ...
        .chancedOutput("gtceu:iron_dust", 5000)
        .duration(100)
        .EUt(16380)
    ...
    event.recipes.gtceu.macerator("alien_scrap_sensor_crushing")
        ...
        .chancedOutput("kubejs:crushed_sensor", 9500)
        .chancedOutput("gtceu:neutronium_dust", 3000)
        .duration(600)
        .EUt(16380)

    event.recipes.gtceu.thermal_centrifuge("alien_scrap_sensor_centrifuge")
        .itemInputs("kubejs:crushed_sensor")
        .chancedOutput("kubejs:necrosiderite_compound", 9500)
        .chancedOutput("gtceu:silver_dust", 5000)
        .duration(600)
        .EUt(16380)
    ...
    event.recipes.gtceu.macerator("alien_scrap_emitter_crushing")
        ...
        .chancedOutput("kubejs:necrosiderite_oxide_glass_dust", 9500)
        .chancedOutput("gtceu:trinium_dust", 5000)
        .duration(400)
        .EUt(16380)
