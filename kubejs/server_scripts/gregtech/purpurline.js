...
ServerEvents.recipes(event =>{
    ...
    event.recipes.gtceu.centrifuge("purpur_dust_separation")
        ...
        .chancedOutput("gtceu:bio_chaff", 5000)
        .chancedOutput("gtceu:purpurite_dust", 2000)
        .chancedOutput("kubejs:ender_shard", 2400)
        .chancedOutput("gtceu:potash_dust", 1500)
        .chancedOutput("gtceu:endstone_dust", 1000)
        .chancedOutput("gtceu:mica_dust", 800)
