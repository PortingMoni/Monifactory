...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.forge_hammer("crystal_seeds_from_exquisite_diamond")
        ...
        .chancedOutput("kubejs:crystal_seeds", 500)
        .duration(200)
    ...
    carbon_containing_fluids.forEach( fluid_type => {
        event.recipes.gtceu.autoclave(`nanotube_growing_in_${fluid_type.name}`)
            ...
            .chancedOutput("kubejs:grown_nanotube_substrate", 7000)
            .chancedOutput("kubejs:failed_nanotube_substrate", 3000)
    ...
    event.recipes.gtceu.macerator("recycle_failed_nanotube_substrate")
        ...
        .chancedOutput("gtceu:gold_dust", 9500)
        .chancedOutput("2x gtceu:cobalt_dust", 9000)
        .chancedOutput("2x gtceu:nichrome_dust", 9500)
        .duration(800)
    ...
    event.recipes.gtceu.cutter("nanotube_separation")
        ...
        .chancedOutput("kubejs:nanotube_substrate", 9500)
        .duration(240)
        .EUt(GTValues.VA[GTValues.EV])
        .cleanroom(CleanroomType.CLEANROOM)
    ...
    event.recipes.gtceu.macerator("recycle_nanotubes")
        ...
        .chancedOutput("kubejs:crystal_seeds", 1500)
        .duration(240)
